export default defineEventHandler(async (event) => {
  ...
  try {
    const url = `${config.public.scanApiUrl}?chainid=${config.public.scanChainId}&module=account&action=txlist&address=${userAddress}&startblock=${startBlock}&endblock=${endBlock}&sort=${sort}&apikey=${config.scanApiKey}`;
